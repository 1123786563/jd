...
export const DEFAULT_ROUTING_MATRIX: RoutingMatrix = {
  high: {
    agent_turn: { candidates: ["qwen3.5-plus","glm-4-flash", "glm-4-plus", "gpt-5.2", "gpt-5.3"], maxTokens: 8192, ceilingCents: -1 },
    heartbeat_triage: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5-mini"], maxTokens: 2048, ceilingCents: 5 },
    safety_check: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5.2", "gpt-5.3"], maxTokens: 4096, ceilingCents: 20 },
    summarization: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5.2", "gpt-5-mini"], maxTokens: 4096, ceilingCents: 15 },
    planning: { candidates: ["qwen3.5-plus","glm-4-plus", "gpt-5.2", "gpt-5.3"], maxTokens: 8192, ceilingCents: -1 },
  },
  normal: {
    agent_turn: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5.2", "gpt-5-mini"], maxTokens: 4096, ceilingCents: -1 },
    heartbeat_triage: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5-mini"], maxTokens: 2048, ceilingCents: 5 },
    safety_check: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5.2", "gpt-5-mini"], maxTokens: 4096, ceilingCents: 10 },
    summarization: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5.2", "gpt-5-mini"], maxTokens: 4096, ceilingCents: 10 },
    planning: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5.2", "gpt-5-mini"], maxTokens: 4096, ceilingCents: -1 },
  },
  low_compute: {
    agent_turn: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5-mini"], maxTokens: 4096, ceilingCents: 10 },
    heartbeat_triage: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5-mini"], maxTokens: 1024, ceilingCents: 2 },
    safety_check: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5-mini"], maxTokens: 2048, ceilingCents: 5 },
    summarization: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5-mini"], maxTokens: 2048, ceilingCents: 5 },
    planning: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5-mini"], maxTokens: 2048, ceilingCents: 5 },
  },
  critical: {
    agent_turn: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5-mini"], maxTokens: 2048, ceilingCents: 3 },
    heartbeat_triage: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5-mini"], maxTokens: 512, ceilingCents: 1 },
    safety_check: { candidates: ["qwen3.5-plus","glm-4-flash", "gpt-5-mini"], maxTokens: 1024, ceilingCents: 2 },
